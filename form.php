...
<body>
	...
	<section id="cart_items">
		...
		<div class="register-req">
				<p><b>Please Fill your form carefully so that you get your Order correctly</b></p>
			</div><!--/register-req-->
   ...
   <input type="text" name="zip_code" placeholder="Zip / Postal Code *">
	<select name="country">
		...
		<option value="uae">UAE</option>
                            ...
                            <textarea name="quantity" placeholder="Expected Time of Delivery *" rows="4" required></textarea>	
							<p>Shipping Order</p>
